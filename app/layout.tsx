...
export const metadata: Metadata = {
  title: 'Dispute Desk - Automate Amazon DSP Disputes',
  ...
  keywords: ['Amazon DSP', 'dispute automation', 'delivery service partner', 'concessions', 'customer feedback', 'DCR', 'RTS', 'Dispute Desk'],
  openGraph: {
    title: 'Dispute Desk - Automate Amazon DSP Disputes',
